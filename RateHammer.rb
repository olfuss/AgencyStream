...
loop do 
	i+=1
		...
		driver6.navigate.to "https://test.quomation.com/HomeQuote.aspx?qid=#{quote6}"
		...
		driver7.navigate.to "https://test.quomation.com/HomeQuote.aspx?qid=#{quote7}"
		...
		driver.navigate.to "https://test.quomation.com/HomeQuote.aspx?qid=#{quote8}"
